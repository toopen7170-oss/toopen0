...
class MainScreen(Screen): # 1. 계정생성창 (통합검색 포함)
    ...
    def show_add(self):
        ...
        self.inp = SInput(hint_text="계정 ID 입력")
...
class CharSelectScreen(Screen): # 2. 케릭선택창 (6개 슬롯)
    def on_enter(self):
...
class SlotMenuScreen(Screen): pass # 슬롯 안의 5개 버튼 창
    ...
    def on_enter(self):
        ...
        for group in self.groups:
            for f in group:
                ...
                del_b.bind(on_release=lambda x, i=inp: app.confirm_pop("전체 삭제?", lambda: i.set_text("")))
...
class ListEditScreen(Screen): # 5. 인벤토리 & 7. 저장보관소
    mode = "inv" 
    def on_enter(self): self.refresh()
    def refresh(self):
        self.ids.cont.clear_widgets()
    ...
    def show_edit(self, idx, val):
        ...
        pop = Popup(title="편집", content=c, size_hint=(0.9, 0.6))
...
<MainScreen>:
    BoxLayout:
        ...
        SInput: hint_text: "계정 또는 캐릭터 검색"; on_text: root.refresh(self.text)
        ScrollView:
...
<CharSelectScreen>:
    ...
    Label: text: "캐릭터 선택 (6슬롯)"; font_name: 'KFont'; size_hint_y: None; height: '70dp'
    GridLayout: id: grid; cols: 2; spacing: 20
    Button: text: "뒤로"; font_name: 'KFont'; size_hint_y: None; height: '75dp'; on_release: app.root.current = 'main'
...
<SlotMenuScreen>:
    BoxLayout:
        ...
        Button: text: "이전 화면"; font_name: 'KFont'; size_hint_y: None; height: '75dp'; background_color: (0.5, 0.5, 0.5, 1); on_release: app.root.current = 'char_select'
...
<InfoScreen>, <EquipScreen>:
    ...
    Button: text: "완료 / 뒤로"; font_name: 'KFont'; size_hint_y: None; height: '75dp'; on_release: app.root.current = 'slot_menu'
...
<PhotoScreen>:
    ...
    Label: text: "사진 선택 (준비 중)"; font_name: 'KFont'; size_hint_y: None; height: '60dp'
    BoxLayout: id: photo_zone; orientation: 'vertical'
    BoxLayout:
        size_hint_y: None; height: '75dp'; spacing: 12
    ...
    Button: text: "뒤로"; font_name: 'KFont'; size_hint_y: None; height: '75dp'; on_release: app.root.current = 'slot_menu'
'''
