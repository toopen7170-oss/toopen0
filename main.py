...
# 키보드가 올라올 때 입력창을 가리지 않도록 설정
Window.softinput_mode = "below_target"

# 데이터 저장소 (버전 v1.2로 업데이트하여 깨끗하게 시작)
store = JsonStore('priston_v1_2.json')

# --- [2. 배경 레이아웃 클래스] bg.png 적용 ---
...
class SBtn(Button):
    def __init__(self, **kw):
        super().__init__(**kw)
        self.font_name = DF
        self.background_normal = '' # 색상 적용을 위해 기본 배경 제거
        self.size_hint_y = None
        self.height = dp(60)
